...
import { SystemModule, SystemDocument } from '../types/system';
...
export const mockDocuments: SystemDocument[] = [
  ...
  },
  {
    ...
    reference: 'TRN-DOC-001',
    url: '/documents/training/orientation'
  },
  {
    id: '7',
    moduleId: 'facilities',
    title: 'Office Safety Guidelines',
    reference: 'FAC-DOC-001',
    url: '/documents/facilities/safety'
  }
];