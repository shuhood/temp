...
import { EmploymentType, SortConfig, SortField } from '../types';
import { mockEmploymentTypes } from '../data/mockData';
import EmploymentTypeRow from '../components/EmploymentTypeRow';
